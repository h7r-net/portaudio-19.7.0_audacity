...
Taken from Audacity project at:

  https://github.com/PortAudio/portaudio/archive/refs/tags/v19.7.0.tar.gz
  https://artifactory.audacityteam.org/artifactory/mirror/portaudio/19.7.0/v19.7.0.tar.gz
  
Includes patches:
  19.7.0:
  - patch_file: patches/19.7.0/wasapi-loopback.patch
  - patch_file: patches/19.7.0/pawinmme-export.patch
  - patch_file: patches/19.7.0/winds-getguid.patch
  - patch_file: patches/19.7.0/enable-oss.patch
